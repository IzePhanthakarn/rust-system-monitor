...
A terminal-based system monitor written in **Rust** using `ratatui`, `crossterm`, and `sysinfo`.

This project provides a simple **TUI (Terminal User Interface)** dashboard to monitor system resources such as:
...
The application updates in real time and is designed as a learning project for building **interactive terminal applications in Rust**.
